    ...
    <section class = "wishlist">
        ...
        <div class = "box-container">
            ...
            <form action = "" class = "box" method = "POST">
                <a href = "wishlist.php?delete=<?= $fetch_wishlist['id']; ?>" class = "fas fa-times" onClick = "return confirm('Delete This Product from Wishlist?'); "></a>
                <a href = "view_page.php?pid=<?= $fetch_wishlist['id']; ?>" class = "fas fa-eye"></a>
